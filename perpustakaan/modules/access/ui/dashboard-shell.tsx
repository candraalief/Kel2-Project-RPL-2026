...
export function DashboardShell({
  ...
  return (
    <main className="h-screen overflow-hidden bg-[#fbfdff] text-zinc-900">
      <PageTransition>
        <div className="grid h-screen w-full grid-rows-[auto_1fr] overflow-hidden bg-white lg:grid-cols-[250px_1fr] lg:grid-rows-none">
