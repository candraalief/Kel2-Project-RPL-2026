  ...
  return (
    <>
      <button
        ...
        className="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-zinc-200 text-base font-semibold text-zinc-700 transition hover:bg-zinc-50"
      >
        -
      </button>
      <input
        ...
        className="h-8 w-16 rounded-lg border border-zinc-200 text-center text-sm font-semibold text-zinc-950 outline-none focus:border-[#1d66d6]"
      />
      <button
        type="button"
...
export function BorrowCheckoutDrawer({
  ...
  return (
    <>
      {isOpen ? (
        <div
          className="cart-backdrop-enter fixed inset-0 z-50 flex justify-end bg-zinc-950/50"
          onClick={() => {
            if (!isPending) {
              closeCart();
            }
        ...
        >
          <aside
            className="cart-drawer-enter flex h-full w-full max-w-xl flex-col bg-white shadow-2xl"
          ...
          >
            <div className="flex shrink-0 items-start justify-between gap-4 border-b border-zinc-200 px-5 py-4">
              ...
              <button
                ...
                onClick={closeCart}
                disabled={isPending}
                className="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-zinc-200 text-lg font-semibold text-zinc-500 transition hover:bg-zinc-100 disabled:cursor-not-allowed disabled:opacity-60"
              >
                x
              </button>
            </div>
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="mt-3 flex flex-wrap items-center gap-2">
                            ...
                            <button
                              ...
                              className="ml-auto inline-flex h-8 items-center justify-center rounded-lg border border-red-200 bg-red-50 px-3 text-xs font-semibold text-red-600 transition hover:bg-red-100"
                            >
                              Hapus
                            </button>
                          </div>
                ...
                <div className="mt-4 space-y-3">
                  <label className="block space-y-1.5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="h-10 w-full rounded-xl border border-zinc-300 bg-white px-3 text-sm text-zinc-900 outline-none transition placeholder:text-zinc-400 focus:border-[#1d66d6]"
                      />
                  ...
                  <label className="block space-y-1.5">
                    ...
                    <input
                      value={adminName}
                      readOnly
                      className="h-10 w-full rounded-xl border border-zinc-200 bg-zinc-100 px-3 text-sm font-semibold text-zinc-700 outline-none"
                    />
                  </label>
                  ...
                  <label className="block space-y-1.5">
                    ...
                    <textarea
                      ...
                      className="w-full resize-y rounded-xl border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 outline-none transition placeholder:text-zinc-400 focus:border-[#1d66d6]"
                    />
                  </label>
                </div>
